...
export default function RootLayout({
  ...
  return (
    <html lang="en" className='!scroll-smooth'>
      ...
      <body
        className={`pt-28 sm:pt-36 bg-gray-50 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90 text-gray-950 ${inter.className}`}
      >
        <div className="bg-[#fbe2e3] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#735370]" />
